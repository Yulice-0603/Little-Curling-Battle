...
Shader "SinCourse/Blend简化"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 temp_output_169_0 = ( ( appendResult154 * _Time.y ) + uv_VertexOffsetTex );
			...
			float2 uv2_DistortionTex = v.texcoord1.xy * _DistortionTex_ST.xy + _DistortionTex_ST.zw;
				...
				float2 staticSwitch38 = uv2_DistortionTex;
			#else
				float2 staticSwitch38 = uv_DistortionTex;
			#endif
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 temp_output_162_0 = ( ( appendResult147 * _Time.y ) + uv_GradientTex );
			...
			float3 lerpResult132 = lerp( float3( ( ( appendResult107 * _Time.y ) + uv_MainTex ) ,  0.0 ) , desaturateVar43 , _DistortionIndensity);
			...
			float2 uv2_AlphaTex = i.uv2_texcoord2 * _AlphaTex_ST.xy + _AlphaTex_ST.zw;
			#ifdef _ALPHATEXUV2_ON
				float2 staticSwitch102 = uv2_AlphaTex;
			#else
				float2 staticSwitch102 = uv_AlphaTex;
			#endif
			float2 appendResult84 = (float2(_Alpha2U , _Alpha2V));
			float2 uv_AlphaTex2 = i.uv_texcoord * _AlphaTex2_ST.xy + _AlphaTex2_ST.zw;
			float2 appendResult90 = (float2(_Alpha3U , _Alpha3V));
			float2 uv_AlphaTex3 = i.uv_texcoord * _AlphaTex3_ST.xy + _AlphaTex3_ST.zw;
			float2 appendResult88 = (float2(_Alpha4U , _Alpha4V));
			float2 uv_AlphaTex4 = i.uv_texcoord * _AlphaTex4_ST.xy + _AlphaTex4_ST.zw;
			float2 appendResult94 = (float2(_Alpha5U , _Alpha5V));
			float2 uv_AlphaTex5 = i.uv_texcoord * _AlphaTex5_ST.xy + _AlphaTex5_ST.zw;
			float3 desaturateInitialColor139 = ( tex2D( _AlphaTex, ( ( appendResult82 * _Time.y ) + staticSwitch102 ) ) * tex2D( _AlphaTex2, ( ( appendResult84 * _Time.y ) + uv_AlphaTex2 ) ) * tex2D( _AlphaTex3, ( ( appendResult90 * _Time.y ) + uv_AlphaTex3 ) ) * tex2D( _AlphaTex4, ( ( appendResult88 * _Time.y ) + uv_AlphaTex4 ) ) * tex2D( _AlphaTex5, ( ( appendResult94 * _Time.y ) + uv_AlphaTex5 ) ) ).rgb;
			...
			float2 uv_SoftDissolveTex = i.uv_texcoord * _SoftDissolveTex_ST.xy + _SoftDissolveTex_ST.zw;
			float2 temp_output_53_0 = ( ( appendResult44 * _Time.y ) + uv_SoftDissolveTex );
...
/*ASEBEGIN
Version=18900
0;249.6;1523.2;275.8;5581.885;-211.6062;2.132828;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-6721.185,-843.0826;Float;False;Property;_DistortionV;DistortionV;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-6721.185,-923.0825;Float;False;Property;_DistortionU;DistortionU;14;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;38;-6486.185,-1122.083;Float;False;Property;_Distortion2UV;Distortion2UV;13;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-8437.996,2071.923;Float;False;Property;_SoftDissolveTexV;SoftDissolveTexV;32;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;41;-6081.185,-1003.083;Inherit;True;Property;_DistortionTex;DistortionTex;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;42;-8440.996,1994.923;Float;False;Property;_SoftDissolveTexU;SoftDissolveTexU;31;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;3;-5671.224,-295.879;Inherit;False;312.6667;165.6667;UV扭曲强度;1;46;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-5621.224,-245.879;Float;False;Property;_DistortionIndensity;DistortionIndensity;16;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;55;-7311.863,2004.051;Float;False;Property;_DistortionInfluenceSoft;DistortionInfluenceSoft;25;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-7302.015,2371.448;Float;False;Property;_DissolveTexPlusValue;DissolveTexPlusValue;30;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;57;-6887.082,1970.972;Inherit;True;Property;_SoftDissolveTex;SoftDissolveTex;26;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-7489.707,3089.502;Float;False;Property;_CustomDataUV2X_Indensity;CustomDataUV2X_Indensity;29;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;66;-7288.896,2564.042;Float;False;Property;_VertexColorInfluenceSoftDissolve;VertexColorInfluenceSoftDissolve;27;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-6256.984,566.333;Float;False;Property;_Alpha2V;Alpha2V;41;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-6251.252,896.0501;Float;False;Property;_Alpha3V;Alpha3V;44;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-6246.613,242.9186;Float;False;Property;_AlphaV;AlphaV;23;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-6267.211,1500.881;Float;False;Property;_Alpha5U;Alpha5U;49;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;68;-7051.96,2923.511;Float;False;Property;_CustomDataUV2XInfluenceSoftDissolve;CustomDataUV2XInfluenceSoftDissolve;28;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-6264.211,1577.88;Float;False;Property;_Alpha5V;Alpha5V;50;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-6263.681,1243.586;Float;False;Property;_Alpha4V;Alpha4V;47;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-6266.681,1166.587;Float;False;Property;_Alpha4U;Alpha4U;46;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-6254.252,819.05;Float;False;Property;_Alpha3U;Alpha3U;43;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-6259.984,489.334;Float;False;Property;_Alpha2U;Alpha2U;40;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-6249.613,165.9184;Float;False;Property;_AlphaU;AlphaU;22;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-6168.997,2343.29;Float;False;Property;_SoftDissolveIndensity;SoftDissolveIndensity;33;0;Create;True;0;0;0;False;0;False;0;0;0;1.05;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-6003.191,-542.1563;Float;False;Property;_MainV;MainV;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-6006.19,-619.156;Float;False;Property;_MainU;MainU;18;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;102;-6252.442,367.4877;Float;False;Property;_AlphaTexUV2;AlphaTexUV2;21;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-5358.726,2316.116;Float;False;Property;_SoftDissolveSoft;SoftDissolveSoft;34;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;129;-5633.905,1491.475;Inherit;True;Property;_AlphaTex5;AlphaTex5;48;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;130;-5624.039,153.3008;Inherit;True;Property;_AlphaTex;AlphaTex;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;124;-5642.407,1147.947;Inherit;True;Property;_AlphaTex4;AlphaTex4;45;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;131;-5629.057,805.615;Inherit;True;Property;_AlphaTex3;AlphaTex3;42;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;128;-5628.887,483.306;Inherit;True;Property;_AlphaTex2;AlphaTex2;39;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;134;-4137.483,2096.175;Float;False;Property;_LineWidth;LineWidth;36;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;140;-5029.747,-434.8525;Float;False;Property;_Color;Color;9;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;144;-5032.672,-741.6589;Inherit;True;Property;_MainTex;MainTex;17;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;146;-3951.892,2317.811;Float;False;Property;_LineRange;LineRange;35;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2441.618,763.009;Float;False;Property;_VertexOffsetTexV;VertexOffsetTexV;54;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;145;-2444.617,686.01;Float;False;Property;_VertexOffsetTexU;VertexOffsetTexU;53;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;-3910.689,-93.79964;Float;False;Property;_OpacityPower;OpacityPower;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-4144.392,-448.1751;Float;False;Property;_MainPower;MainPower;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;211;-3223.979,-164.0996;Float;False;Property;_SoftDissolveSwitch;SoftDissolveSwitch;24;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;181;-2633.671,130.7636;Float;False;Property;_DepthFadeIndensity;DepthFadeIndensity;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;182;-1770.347,1091.901;Float;False;Property;_DistortionInfluenceOffset;DistortionInfluenceOffset;51;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;187;-2252.973,-74.12618;Float;False;Property;_Opacity;Opacity;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-2975.708,-561.3427;Float;False;Property;_Indensity;Indensity;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;198;-2540.218,-546.0905;Float;False;Property;_LineColor;LineColor;37;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;195;-2499.8,-376.2324;Float;False;Property;_LineIndensity;LineIndensity;38;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;189;-1588.167,646.5861;Inherit;True;Property;_VertexOffsetTex;VertexOffsetTex;52;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;201;-1379.621,567.967;Float;False;Property;_VertexOffsetIndensity;VertexOffsetIndensity;55;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;213;-1609.913,-160.9695;Float;False;Property;_DepthFade;DepthFade;5;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-771.0934,-55.19758;Float;False;True;-1;2;ASEMaterialInspector;0;0;Lambert;SinCourse/Blend简化;False;False;False;False;True;True;True;True;True;True;True;True;False;False;False;False;False;False;False;False;False;Off;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Custom;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=1BE02E58F5B2D77E778A6FFD6AE12BE1A0B0BDA6